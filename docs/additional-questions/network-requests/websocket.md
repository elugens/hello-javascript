...
**Question:** **Can you briefly describe the WebSocket protocol?**
...
**Question:** **What do we need to open a websocket connection?**
...
**Question:** **What is the preferred mode for a websocket connection?**
...
**Question:** **After we create a websocket connection, what events can we listen for?**
...
**Question:** **What happens during initial state of opening a websocket connection?**
...
**Question:** **In the browser header, what does the origin refer to in websocket connections?**
...
**Question:** **What does the connection upgrade signal?**

**Interview Answer:** The connection upgrade signals that the client would like to change the protocol.

Source: <https://javascript.info/websocket#opening-a-websocket>

**Question:** **What happens after the connection upgrade request with a websocket?**
...
**Question:** **Can the WebSocket handshake be emulated with XMLHttpRequest or fetch?**
...
**Question:** **What is the server code response used during a switch WebSocket protocol?**
...
**Question:** **What does deflate-frame mean in relation to Sec-WebSocket-Extensions?**
...
**Question:** **What does the Sec-WebSocket-Protocol: soap, wamp mean?**
...
**Question:** **What are frames in relation to WebSocket communication?**
...
**Question:** **Explain the function and syntax of the WebSocket.send() method.**
...
**Question:** **When WebSocket returns text or binary data to us, what object type is it?**
...
**Question:** **How should we handle a slow network connection in relation to WebSocket communication?**
...
**Question:** **What happens when ether the browser or server closes a connection?**
...
**Question:** **What are the common closure codes for WebSocket?**
...
**Question:** **How can we get the connection state of a WebSocket connection?**

...
**Question:** **Can you explain, what is the same origin policy?**
...
**Question:** **What are the rules for origin policy for an iframe?**
...
**Question:** **What is the difference between iframe.onload vs iframe.contentWindow.onload?**
...
**Question:** **How do subdomains operate in the context of the same origin policy?**
...
**Question:** **Are there any pitfalls when an iframe attempts to access its document?**
...
**Question:** **Is there a way to detect the moment when the document is loaded into an iframe?**
...
**Question:** **What approach should you use to access window object for an iframe?**
...
**Question:** **What is the purpose of the “sandbox” iframe attribute?**
...
**Question:** **Can you explain what the postMessage interface message does?**
...
**Question:** **How does the postMessage method work in relation to an iframe?**
...
**Question:** **How would you receive a message from a postMessage?**

...
**Question:** **How does square brackets […] perform in regular expression sets?**
...
**Question:** **Explain, how is a range denoted in a regular expression?**
...
**Question:** **Is there a way to handle Han (Chinese) or Cyrillic in regexp ranges?**
...
**Question:** **How do you exclude a range of characters in regular expressions?**
...
**Question:** **Do we have to escape special characters in regex sets or ranges?**
...
**Question:** **What is the recommended way to match against surrogate pairs in a set or range?**
